...
cd C:\_code\personal_github\AzureAppInsight-Java-Demo\_src; $env:JAVA_HOME = "C:\Program Files\Java\jdk-25"; $env:PATH = "$env:JAVA_HOME\bin;" + $env:PATH; java --add-opens java.base/java.lang=ALL-UNNAMED --add-opens java.base/sun.nio.ch=ALL-UNNAMED -javaagent:applicationinsights-agent.jar -jar target\azure-appinsight-demo-1.0.0.jar
